...
begin
    try
      ...
      begin
        ...
        mSql:= 'insert into fornecedores ( fornecedor,RazaoSocial, RG, CPF, Sexo, Telefone, Celular, Email, CEP, Bairro, Logradouro, Numero, Complemento, CNPJ, Site, Observacao, codCidade, FormaPag, DataNasc) ' + ' values(:Fornecedor,:RG,:CPF,:Sexo,:Telefone,:celular,:Email,:CEP,:Bairro,:Logradouro,:Numero,:Complemento,:CNPJ, :Site, :Observacao, :FormaPag, :codCidade, :RazaoSocial,:DataNasc)'
        else
        begin
          mSql := ' update Fornecedores set fornecedor = :fornecedor,RazaoSocial= :RazaoSocial,RG= :RG,CPF= :CPF,Sexo= :Sexo,Telefone= :Telefone,celular= :celular,Email= :Email,CEP= :CEP,Bairro= :Bairro,Logradouro= :Logradouro,Numero= :Numero, ' + ' Complemento= :Complemento, CNPJ = :CNPJ, Site= :Site, Observacao= :Observacao,  FormaPag= :FormaPag, DataNasc= :DataNasc, codCidade = :codCidade';
        ...
        ParamByName('DataNasc').Value :=mFornecedor.getDataNasc;
        if mFornecedor.getCodigo <> 0 then
